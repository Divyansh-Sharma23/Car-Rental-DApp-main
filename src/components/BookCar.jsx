              ...
              <form className="box-form">
                <div className="box-form__car-type">
                  ...
                  <select value={carType} onChange={handleCar}>
                    ...
                    <option value="Maruti Suzuki Ertiga">Ertiga</option>
                    <option value="Mahindra Scorpio">Scorpio</option>
                    <option value="Toyota Innova Crysta">Innova Crysta</option>
                    <option value="Hyundai Verna">
                      Verna
                    </option>
                    <option value="Mahindra Thar">Thar</option>
                    <option value="Tata Nexon">Nexon</option>
                  </select>
                </div>
